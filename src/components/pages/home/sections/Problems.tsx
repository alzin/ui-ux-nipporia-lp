      ...
      <div className="max-w-[1200px] mx-auto px-8">
        ...
        <div className="animate-slide grid grid-cols-1 md:grid-cols-3 gap-8">
          {problems.map((problem, index) => (
            <div
              key={index}
              className="problem-card bg-white/[0.02] border border-white/10 rounded-[20px] p-8 relative overflow-hidden group hover:-translate-y-[5px] hover:border-error/30 hover:shadow-[0_20px_40px_rgba(239,68,68,0.2)] transition-all duration-[0.8s] ease-linear"
            >
              ...
              <div className="relative z-10">
                <div
                  className={`text-[3rem] mb-4 inline-block animate-iconShake ${
                    index === 0
                      ? "animation-delay-0"
                      : index === 1
                      ? "animation-delay-500"
                ...
                <h3 className="text-[1.5rem] mb-4 text-error font-semibold">
                  {problem.title}
                </h3>
