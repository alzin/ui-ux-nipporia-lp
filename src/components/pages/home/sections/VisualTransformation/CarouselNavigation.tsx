  ...
  return (
    <>
      ...
      <div className={`relative z-10 md:hidden flex items-center justify-center gap-3 px-4 pb-2 ${isRTL ? "flex-row-reverse" : ""}`}>
        ...
        >
          <svg aria-hidden="true" className={`w-5 h-5 ${isRTL ? "rotate-180" : ""}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      >
        <svg aria-hidden="true" className="w-6 h-6 md:w-8 md:h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d={prevArrowPath} />
        </svg>
      </button>
