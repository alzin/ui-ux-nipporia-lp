...
import { BlogTocDesktop, BlogTocMobile } from "./BlogTableOfContents";
...
const BlogPage: React.FC<IBlogPage> = ({ blog }) => {
  ...
  return (
    <div className="container mx-auto px-4 py-8 mt-[80px] max-w-7xl">
      {/* Mobile: title + meta + image (before sticky TOC) */}
      <div className="lg:hidden">
        ...
        {blog.metadata.images && blog.metadata.images[0] ? (
          <div className="mb-6 relative w-full rounded-2xl overflow-hidden">
            <Image
          ...
          <div className="w-full aspect-video bg-gradient-to-br from-purple-100 to-cyan-100 mb-6 rounded-2xl" />
        )}
      </div>

      {/* Mobile: sticky TOC — direct child of tall container so sticky works */}
      <BlogTocMobile />
