export function initHomeScript() {
  ...
  // Process timeline enhanced animation (specific to ProcessSection)
  ...
  document
    .querySelectorAll(".problem-card, .service-card, .transformation-card")
    .forEach((card) => {
  ...
  // Add magnetic effect to CTA buttons (specific to CTASection)
