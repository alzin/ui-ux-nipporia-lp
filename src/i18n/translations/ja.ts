...
const ja: Translations = {
  ...
  problems: {
    ...
    items: [
      {
        title: "バラバラな施策と無駄なコスト",
        description:
          "ウェブサイト・広告・アプリ・SEOをそれぞれ別々に管理している — 連携が取れず、コストが膨らみ、成果がほとんど見えない状態が続いています。",
      },
      {
        title: "急速に変化するデジタル世界に取り残される",
        description:
          "競合他社がAIや最新ツールを活用して成長し続ける中、自社は時代遅れのシステムに縛られ成長の機会を逃しています。",
      },
      {
        title: "投資は増えても成果は減るばかり",
        description:
          "ウェブサイトや広告に費用をかけているのに、見込み客も売上も増えず、何が問題なのかも把握できていません。",
      },
    ],
  },
