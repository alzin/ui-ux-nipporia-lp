...
const ar: Translations = {
  ...
  problems: {
    ...
    items: [
      {
        title: "جهود متشتتة وميزانية مهدرة",
        description:
          "موقعك والإعلانات والتطبيقات وتحسين محركات البحث تُدار بشكل منفصل — مما يؤدي إلى عدم التنسيق وارتفاع التكاليف وتأثير لا يكاد يُقاس.",
      },
      {
        title: "التخلف في عالم رقمي متسارع",
        description:
          "بينما يستفيد المنافسون من الذكاء الاصطناعي والأدوات الحديثة، تظل شركتك حبيسة أنظمة قديمة تعيق النمو.",
      },
      {
        title: "استثمار متزايد وعائد متراجع",
        description:
          "تضخ الأموال في المواقع والإعلانات — لكنك لا تحصد عملاء محتملين أو إيرادات أو رؤى واضحة حول ما يسير في الاتجاه الخاطئ.",
      },
    ],
  },
  ...
  requirementsSheet: {
    tag: "قالب مجاني",
    title: "ورقة تنظيم المتطلبات (Word)",
    description:
