...
const ar: Translations = {
  ...
  problems: {
    sectionTitle: "التحديات والحلول",
    problemLabel: "التحدي",
    solutionLabel: "الحل",
    items: [
      {
        problem:
          "لديك مشكلة تريد حلها باستخدام الذكاء الاصطناعي التوليدي، لكنك لا تعرف الطريقة الملموسة للبدء…",
        solution: {
          title: "توضيح نهج الحل المناسب",
          description:
            "يُفكّك خبراؤنا خلفية التحدي واحتياجات المستخدم الجوهرية لتوضيح كيفية حله. حتى لو بدأت من فكرة غير واضحة، نتعمق في المتطلبات ونختار التقنية المناسبة لتحويلها إلى نهج محدد وأمثل.",
        },
      },
      {
        problem:
          "لديك تصور للنظام الذي تريد بناءه، لكنك لست متأكداً من أنه التصور الصحيح…",
        solution: {
          title: "تصميم نموذج أولي يعزز فرص النجاح",
          description:
            "بالاستناد إلى خبرة واسعة في تطوير الذكاء الاصطناعي التوليدي، نتحقق من الجدوى من زوايا متعددة. ومن خلال تدفقات تجربة المستخدم وتعريف المنتج الأدنى القابل للتطبيق، نصمم نموذجاً أولياً يوضح ما يجب بناؤه وإلى أي مدى، ويُقلل من مخاطر فشل المشروع.",
        },
      },
      {
        problem:
          "تريد إبقاء التكاليف الأولية منخفضة، لكن التقديرات دائماً ما تتجاوز الميزانية…",
        solution: {
          title: "هيكل تكلفة مُحسَّن لانطلاقة سلسة",
          description:
            "نقترح هيكل التكلفة الأنسب لحالتك — تقسيم المراحل، نموذج أولي صغير الحجم، تطوير مشترك، وغيرها. أبقِ الاستثمار الأولي منخفضاً وابنِ نظام الذكاء الاصطناعي التوليدي خطوة بخطوة بشكل مستدام.",
        },
      },
    ],
  },
  ...
  requirementsSheet: {
    tag: "قالب مجاني",
    title: "ورقة تنظيم المتطلبات",
    description:
      "قالب جاهز لتنظيم التحديات والمستخدمين والمزايا المطلوبة والجدول الزمني والميزانية قبل التواصل مع شركة تطوير. اطّلع على المعاينة أدناه، ثم نزّل الملف لتعبئته.",
    viewOnly: "للعرض فقط",
    viewOnlyNote:
      "هذه المعاينة للعرض فقط. لا يمكن تعديل محتوى المستند أو نسخه. يُرجى تنزيل الملف لتعبئته.",
    ...
    modal: {
      ...
      cancel: "إلغاء",
      privacyNote:
        "تتم معالجة بياناتك وفقًا لسياسة الخصوصية ولن يتم بيعها أو مشاركتها لأغراض تسويقية.",
      successTitle: "بدأ التنزيل",
      successMessage:
        "سيبدأ تنزيل الملف تلقائيًا. إذا لم يبدأ، يُرجى المحاولة مرة أخرى.",
      errorMessage: "حدث خطأ. يُرجى المحاولة لاحقًا.",
